...
function CourseComparisonPageContent() {
    ...
    useEffect(() => {
        ...
        const fetchCourses = async () => {
            try {
                setLoading(true);
                const cleanedCourses = selectedCourses.map(course => course.replace(/\s+/g, ''));
                const courseData = await compareCourses(cleanedCourses);
                setCourses(courseData);
                setError(null);
            } catch (err) {
                console.error('Error fetching course comparison:', err);
                setError(err instanceof Error ? err.message : 'Failed to load course comparison');
            } finally {
                setLoading(false);
            }
        };
    ...
    const getDifficultyBadgeColor = (difficulty: string) => {
        switch (difficulty) {
            ...
            case "Rigorous": return "bg-red-200 text-red-900 border-red-300";
    ...
    const courseAnalysis = useMemo(() => {
        ...
        const ratings = courses.map(c => c.rating).filter((r): r is number => r !== undefined && r > 0);
        const enrollments = courses.map(c => c.enrollment).filter((e): e is number => e !== undefined && e > 0);
        const difficulties = courses.map(c => getDifficultyScore(c.difficulty)).filter(d => d > 0);
        ...
        return {
            ...
            easiestDifficulty: difficulties.length > 0 ? Math.min(...difficulties) : 0,
            hardestDifficulty: difficulties.length > 0 ? Math.max(...difficulties) : 0,
            avgCredits: courses.reduce((sum, c) => sum + c.credits, 0) / courses.length
        };
    }, [courses]);
                ...
                <main className="pt-24 pb-20">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-xl font-semibold text-heading mb-2">Loading Course Comparison</h3>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="mb-12">
                        <div className="flex items-center justify-between mb-6">
                            <Link href="/courses">
                                <Button variant="outline" className="flex items-center gap-2 hover:bg-[#500000] hover:text-white transition-colors">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-xl text-body max-w-3xl mx-auto">
                                In-depth comparison of {courses.length} courses with detailed metrics, analytics, and insights to help you make informed decisions.
                            </p>
                        </div>
                                ...
                                <Card className="p-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white border-transparent">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-lg font-bold">{courseAnalysis.bestGPA.toFixed(2)}</div>
                                        </div>
                                    </div>
                                </Card>
                                <Card className="p-4 bg-gradient-to-r from-blue-500 to-cyan-600 text-white border-transparent">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-lg font-bold">{courseAnalysis.bestRating.toFixed(1)}</div>
                                        </div>
                                    </div>
                                </Card>
                                <Card className="p-4 bg-gradient-to-r from-purple-500 to-pink-600 text-white border-transparent">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-lg font-bold">{courseAnalysis.highestEnrollment.toLocaleString()}</div>
                                        </div>
                                    </div>
                                </Card>
                                <Card className="p-4 bg-gradient-to-r from-orange-500 to-red-600 text-white border-transparent">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-lg font-bold">{courseAnalysis.avgCredits.toFixed(1)}</div>
                                        </div>
                                    </div>
                                </Card>
                            </div>
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        ...
                        <TabsContent value="overview" className="space-y-6">
                            <div className={`grid grid-cols-1 ${courses.length === 2 ? 'md:grid-cols-2' : courses.length === 3 ? 'md:grid-cols-3' : 'md:grid-cols-2 lg:grid-cols-4'} gap-6`}>
                                {courses.map((course, index) => (
                                    <Card key={course.code} className="bg-gradient-to-br from-card to-card/50 border-border hover:shadow-xl transition-all duration-300 hover:scale-[1.02] relative overflow-hidden">
                                        {/* Course Rank Badge */}
                                        <div className="absolute top-4 right-4 z-10">
                                            <Badge className={`${index === 0 ? 'bg-yellow-500' : index === 1 ? 'bg-gray-400' : 'bg-orange-500'} text-white`}>
                                                #{index + 1}
                                            </Badge>
                                        </div>
                                        ...
                                        <CardHeader className="pb-4 relative z-10">
                                            <div className="text-center">
                                                ...
                                                <div className="flex justify-center gap-2">
                                                    <Badge variant="outline" className="text-xs bg-blue-500 border-blue-700">
                                                        <BookOpen className="w-3 h-3 mr-1" />
                                                        {course.credits} Credits
                                                    </Badge>
                                                    <Badge variant="outline" className="text-xs bg-purple-500 border-purple-700">
                                        ...
                                        <CardContent className="space-y-6">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="text-center p-3 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border border-green-200">
                                                    ...
                                                    <div className="text-xs text-green-600 font-medium">Average GPA</div>
                                                </div>
                                                <div className="text-center p-3 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg border border-yellow-200">
                                                    ...
                                                    <div className="text-xs text-yellow-600 font-medium">Student Rating</div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <span className="text-sm font-medium text-body">Enrollment</span>
                                            ...
                                            {course.prerequisites && course.prerequisites.length > 0 && (
                                                <div>
                                                    <h4 className="text-sm font-medium text-heading mb-2">Prerequisites</h4>
                                        ...
                                        <table className="w-full">
                                            <thead>
                                                <tr className="border-b border-border bg-gray-50/50">
                                                    <th className="text-left p-4 font-medium text-heading">Metric</th>
                                                    {courses.map((course) => (
                                                        <th key={course.code} className="text-center p-4 font-medium text-heading min-w-[150px]">
                                                            {course.code}
                                                        </th>
                                                    ))}
                                                </tr>
                                            ...
                                            <tbody>
                                                <tr className="border-b border-border hover:bg-gray-50/50">
                                                    <td className="p-4 font-medium text-body">Course Name</td>
                                                    {courses.map((course) => (
                                                        <td key={course.code} className="p-4 text-center text-sm text-body">
                                                            {course.name}
                                                        </td>
                                                    ))}
                                                </tr>
                                                ...
                                                <tr className="border-b border-border hover:bg-gray-50/50">
                                                    <td className="p-4 font-medium text-body">Average GPA</td>
                                                    {courses.map((course) => (
                                                        <td key={course.code} className="p-4 text-center">
                                                            <span className={`font-semibold ${course.avgGPA >= 3.5 ? 'text-green-600' : course.avgGPA >= 3.0 ? 'text-yellow-600' : 'text-red-600'}`}>
                                                                {course.avgGPA !== -1 ? course.avgGPA.toFixed(2) : 'N/A'}
                                                            </span>
                                                        </td>
                                                    ))}
                                                ...
                                                <tr className="border-b border-border hover:bg-gray-50/50">
                                                    <td className="p-4 font-medium text-body">Student Rating</td>
                                                    {courses.map((course) => (
                                                        <td key={course.code} className="p-4 text-center">
                                                ...
                                                <tr className="border-b border-border hover:bg-gray-50/50">
                                                    <td className="p-4 font-medium text-body">Difficulty</td>
                                                    {courses.map((course) => (
                                                        <td key={course.code} className="p-4 text-center">
                                                            <Badge className={getDifficultyBadgeColor(course.difficulty)}>
                                                                {course.difficulty}
                                                ...
                                                <tr className="border-b border-border hover:bg-gray-50/50">
                                                    <td className="p-4 font-medium text-body">Enrollment</td>
                                                    {courses.map((course) => (
                                                        <td key={course.code} className="p-4 text-center font-semibold text-body">
                                                            {course.enrollment?.toLocaleString() || 'N/A'}
                                                        </td>
                                                    ))}
                                                </tr>
                                                <tr className="border-b border-border hover:bg-gray-50/50">
                                                    <td className="p-4 font-medium text-body">Sections</td>
                                                    {courses.map((course) => (
                                                        <td key={course.code} className="p-4 text-center font-semibold text-body">
                                                            {course.sections || 'N/A'}
                                                        </td>
                                                ...
                                                <tr className="border-b border-border hover:bg-gray-50/50">
                                                    <td className="p-4 font-medium text-body">Prerequisites</td>
                                                    {courses.map((course) => (
                                                        <td key={course.code} className="p-4 text-center">
                                                            {course.prerequisites && course.prerequisites.length > 0 ? (
                                            ...
                                            {course.professors && course.professors.length > 0 ? (
                                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                    {course.professors.map((prof, index) => (
                                                        <Card key={index} className="p-4 bg-gradient-to-br from-gray-600/30 to-blue-300/60 border-gray-200">
                                                            <div className="flex items-start justify-between mb-3">
                                                                <div>
                                                                    <h4 className="font-semibold text-heading text-sm">{prof.name}</h4>
                                                                    <div className="flex items-center gap-1 mt-1">
                                                                        <Star className="w-3 h-3 text-yellow-500 fill-current" />
                                                                        <span className="text-xs font-medium">
                                                                            {prof.rating ? prof.rating.toFixed(1) : 'N/A'}
                                                                        </span>
                                                            ...
                                                            {prof.gradeDistribution && (
                                                                <div className="space-y-2">
                                                                    <h5 className="text-xs font-medium text-body">Grade Distribution</h5>
                                                                    <div className="grid grid-cols-5 gap-1">
                                                                        {Object.entries(prof.gradeDistribution).map(([grade, percentage]) => (
                                                                            <div key={grade} className="text-center">
                                                                                <div className={`w-full h-8 ${getGradeColor(grade)} rounded-sm flex items-center justify-center text-white text-xs font-bold`}>
                                                                                    {grade}
                                                                                </div>
                                                                                <div className="text-xs text-body mt-1">{percentage}%</div>
                                                                            </div>
                                                                        ))}
                                                                    </div>
                                                                </div>
                                                            ...
                                                            {prof.teachingStyle && (
                                                                <div className="mt-3">
                                                                    <h5 className="text-xs font-medium text-body mb-1">Teaching Style</h5>
                                                                    <p className="text-xs text-body">{prof.teachingStyle}</p>
                                                                </div>
                                                            )}
                                                        </Card>
                                                    ))}
                                        ...
                                        <CardContent className="space-y-6">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div className="space-y-4">
                                                    <h4 className="font-semibold text-heading">GPA Distribution</h4>
                                                    <div className="space-y-2">
                                                        {courses.map((course) => (
                                                            <div key={course.code} className="flex items-center gap-3">
                                                                <div className="w-16 text-sm font-medium text-body">{course.code}</div>
                                                ...
                                                {/* Rating Analysis */}
                                                <div className="space-y-4">
                                                    <h4 className="font-semibold text-heading">Student Ratings</h4>
                                                    <div className="space-y-2">
                                                        {courses.map((course) => (
                                                            <div key={course.code} className="flex items-center gap-3">
                                                                <div className="w-16 text-sm font-medium text-body">{course.code}</div>
                                            ...
                                            <div className="bg-blue-50/10 border border-blue-200 rounded-lg p-6">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <div>
                                                            <h5 className="font-medium text-heading text-sm">Easiest Course</h5>
                                                            <p className="text-sm text-body">
                                                                {courses.find(c => getDifficultyScore(c.difficulty) === courseAnalysis.easiestDifficulty)?.code} -
                                                    ...
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <div>
                                                            <h5 className="font-medium text-heading text-sm">Highest Rated</h5>
                                                            <p className="text-sm text-body">
                                                                {courses.find(c => c.rating === courseAnalysis.bestRating)?.code} -
                                                    ...
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <div>
                                                            <h5 className="font-medium text-heading text-sm">Best GPA</h5>
                                                            <p className="text-sm text-body">
                                                                {courses.find(c => c.avgGPA === courseAnalysis.bestGPA)?.code} -
                                                    ...
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <div>
                                                            <h5 className="font-medium text-heading text-sm">Most Popular</h5>
                                                            <p className="text-sm text-body">
                                                                {courses.find(c => c.enrollment === courseAnalysis.highestEnrollment)?.code} -
                                                                High student demand
                                                            </p>
                                                        </div>
                                                    </div>
