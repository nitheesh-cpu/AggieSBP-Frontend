                ...
                {professor.overall_summary && (
                  <div className="mt-4 pt-4 border-t border-border">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <Badge
                        variant="outline"
                        className="text-xs bg-blue-600 dark:bg-blue-500 text-white border-transparent font-medium"
                      >
                        Generated by AI
                      </Badge>
                    </div>
                    <div className="bg-gradient-to-r from-[#500000]/5 to-[#600000]/5 border border-[#500000]/20 rounded-lg p-4">
                      ...
                      {professor.departments.map((dept, index) =>
                        dept ? (
                          <Badge
                            key={index}
                            variant="outline"
                            className="bg-button-primary dark:bg-button-primary text-white border-transparent px-2 py-1 text-xs"
                          >
                            {dept}
                          </Badge>
                        ) : null
                  ...
                  Object.keys(professor.tag_frequencies).length > 0 && (
                    <div className="mt-4 pt-4 border-t border-border">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {Object.keys(professor.tag_frequencies).length > 6 && (
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => setShowAllTags(!showAllTags)}
                            className="text-xs text-[#500000] hover:text-[#600000] hover:bg-[#500000]/10 h-6 px-2"
                          >
                            {showAllTags ? (
                              <>
                        ...
                        {Object.entries(professor.tag_frequencies)
                          ...
                          .map(([tag, frequency]) => (
                            <Badge
                              key={tag}
                              variant="outline"
                              className="bg-emerald-600 dark:bg-emerald-500 text-white border-transparent px-3 py-1 text-xs font-medium"
                            >
                              {tag} ({frequency})
                            </Badge>
                          ))}
