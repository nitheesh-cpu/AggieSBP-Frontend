...
import { Department, DepartmentsInfo, Course, CourseDetail } from './api';
...
export const mockDepartmentsInfo: DepartmentsInfo = {
    ...
    top_departments_by_courses: [
        { code: 'CSCE', name: 'Computer Science & Engineering', courses: 180, professors: 95, avgGpa: 3.05, rating: 3.9 },
        { code: 'MATH', name: 'Mathematics', courses: 165, professors: 78, avgGpa: 2.95, rating: 3.6 },
        { code: 'PHYS', name: 'Physics & Astronomy', courses: 142, professors: 65, avgGpa: 3.15, rating: 3.7 }
    ],
    recent_semesters: [],
    data_sources: {
...
export const mockDepartments: Department[] = [
    {
        ...
        description: 'Department of Computer Science and Engineering offering comprehensive programs in computing and software engineering.'
    },
    {
        id: '2',
        code: 'MATH',
    ...
    },
    {
        ...
        description: 'Department of English focusing on literature, writing, and communication skills.'
    },
    {
        id: '4',
        code: 'BUAD',
        ...
        description: 'Mays Business School offering comprehensive business education and leadership development.'
    },
    {
        id: '5',
        code: 'AGRI',
        ...
        description: 'College of Agriculture and Life Sciences providing education in agricultural sciences and technology.'
    }
];
...
export const mockCourses: Course[] = [
    {
        ...
        sections: 8,
        rating: 3.8,
        description: 'Introduction to programming using object-oriented techniques.',
